# Generated by Powerlevel10k configuration wizard on 2020-05-17 at 11:37 CEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 24353.
# Wizard options: awesome-fontconfig, large icons, rainbow, time, blurred tails,
# 2 lines, solid, no frame, darkest, sparse, many icons, fluent, transient_prompt,
# instant_prompt=off.
